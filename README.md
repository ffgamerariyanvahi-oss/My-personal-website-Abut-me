...
<head>
    ...
    <title>Itz Faysal - Bio Profile</title>
    <meta name="description" content="ITZ FAYSAL - Professional Profile and Portfolio">
    <meta name="keywords" content="ITZ FAYSAL, ITZ FAYSAL, profile, portfolio">
    <meta name="author" content="ITZ FAYSAL">
...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center h-100">
        <div class="profile-card">
            <img src="https://i.ibb.co/0RQ4qR12/e28a227e64.jpg" alt="Profile Picture" class="profile-img">
            <div class="profile-info">
                <h1>ITZ FAYSAL</h1>
                <p class="designation">DARK BOY FAYSAL</p>
                <p class="bio">আসসালামু আলাইকুম! " আসুন হ্যাকিং শিখি নিজেকে সুরক্ষিত রাখি ও অন্যকেও সুরক্ষিত রাখি। কেউ যদি আমাদের টিম থেকে কিছু শিখে যদি কোন কাজে অপব্যবহার করেন তাহলে তার দায়িত্ব আমাদের টিম নিবে না। যেকোন সমস্যা সমাধানে যোগাযোগ করুন!! ✔️</p>
            </div>
            <div class="social-links">
                <a href="https://t.me/ariyan_Cyber_Zone" class="social-icon" data-tooltip="Telegram Channel"><i class="fab fa-telegram-plane"></i></a>
                <a href="https://t.me/Ariyan_Mod_X420" class="social-icon" data-tooltip="Community"><i class="fab fa-discourse"></i></a>
            </div>
        </div>
    </div>
